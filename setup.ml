...
(* OASIS_START *)
(* DO NOT EDIT (digest: d7db4c656a1e0716b79a10074e2ff041) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$benchmark_test", []))];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build Xen library";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("optcomp.ppx", None)
                        ];
                   ...
                   {
                      lib_modules = ["Trace"; "Counter"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-profile";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "mProf"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["MProf_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mProf";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\193G3\252CA\157\026\016\216\190\189n\220w\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
