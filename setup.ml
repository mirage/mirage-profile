...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ed591ff9931e0c0ea917c48306c0766) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["MProf"];
                      lib_pack = false;
                      lib_internal_modules = ["MProf_trace"; "MProf_counter"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\216\178-i\186#\2483Y\134\227W\024v\189\029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
